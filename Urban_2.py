#      Цель задания:
# Освоить создание функций с параметрами по умолчанию и практику
...
'''Вводим словарь и список:'''
values_list = [7, False, 'Air']
values_dict = {'a' : 7, 'b' : 'Fair', 'c' : False}


'''Проверка функции на распаковку списка и словаря:'''
print_params(*values_list)
print_params(**values_dict)


'''Вводим новый список с двумя аргументами:'''
values_list_2 = [2, 'Ship']


'''Проверка функции на распаковку списка c двумя аргументами:'''
